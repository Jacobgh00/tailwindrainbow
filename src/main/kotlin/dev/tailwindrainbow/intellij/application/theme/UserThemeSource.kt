...
/**
 * The user's own palettes, parsed leniently.
 *
 * Registered after the built-in source, so a spec named `default` retints only the entries it lists
 * and inherits the rest. Pure logic: it takes already-deserialised [ThemeSpec]s and knows nothing
 * about where they were stored.
 */
